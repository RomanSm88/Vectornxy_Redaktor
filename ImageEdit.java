...
public class ImageEdit
{
    ...
    public ImageEdit()
    {
        ...
        JToolBar toolbar = new  JToolBar("Toolbar", JToolBar.VERTICAL);
          ...
          JButton penbutton = new  JButton(new  ImageIcon("./icon_interface/pen.png"));
          ...
          JButton brushbutton = new  JButton(new  ImageIcon("./icon_interface/brush.png"));
          ...
          JButton lasticbutton = new JButton(new  ImageIcon("./icon_interface/lastic.png"));
          ...
          JButton textbutton = new  JButton(new  ImageIcon("./icon_interface/text.png"));
          ...
          JButton linebutton = new  JButton(new  ImageIcon("./icon_interface/line.png"));
          ...
          JButton elipsbutton = new  JButton(new  ImageIcon("./icon_interface/elips.png"));
          ...
          JButton rectbutton = new  JButton(new  ImageIcon("./icon_interface/rect.png"));
